...
def main():
    with gr.Blocks() as interface:
        ...
        #Character Network Session      TODO: Clean up the character network by checking character names with data           
        with gr.Row():
            with gr.Column():
